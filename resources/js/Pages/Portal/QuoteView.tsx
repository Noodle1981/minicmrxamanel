    ...
    return (
        ...
        >
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl glass-panel print:hidden">
                    <span className="text-xs text-white/60">
                        Documento oficial emitido por <strong className="text-white">Grupo Xamanen</strong>
                    </span>
                    <button
                        type="button"
